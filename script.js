...
if (splineViewer && splineLoading) {
    ...
    /*
       Spline Viewer memancarkan
       event load ketika scene selesai.
    */
    ...
    /*
       Fallback:
       jangan biarkan indikator loading
       selamanya jika browser tidak mengirim
       event load.
    */
...
const projectData = {
    ...
    data: {
        ...
        details:
            "Project ini berfokus pada proses pengolahan data mulai dari data cleaning, exploratory data analysis, identifikasi pola, hingga visualisasi.",
